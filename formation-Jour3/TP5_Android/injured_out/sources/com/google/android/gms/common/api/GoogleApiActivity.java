...
public class GoogleApiActivity extends Activity implements DialogInterface.OnCancelListener {
    ...
    protected void onActivityResult(int i, int i2, Intent intent) {
        ...
        if (i == 1) {
            ...
            setResult(i2, intent);
            if (booleanExtra) {
                com.google.android.gms.common.api.internal.e f = com.google.android.gms.common.api.internal.e.f(this);
                if (i2 == -1) {
                    f.t();
                } else if (i2 == 0) {
                    f.b(new b.c.a.a.b.a(13, null), getIntent().getIntExtra("failing_client_id", -1));
                }
            }
        } else if (i == 2) {
            this.f = 0;
        ...
        if (this.f != 1) {
            ...
            if (extras == null) {
                ...
                if (pendingIntent == null && num == null) {
                    ...
                    b.c.a.a.b.d.l().m(this, num.intValue(), 2, this);
                    this.f = 1;
                    return;
                } else {
                    try {
