...
public abstract class FabTransformationBehavior extends ExpandableTransformationBehavior {
    ...
    private final Rect f1862c;

    /* renamed from: d  reason: collision with root package name */
    private final RectF f1863d;
    ...
    public class c extends AnimatorListenerAdapter {
        ...
        /* renamed from: a  reason: collision with root package name */
        final /* synthetic */ b.c.a.b.p.d f1868a;

        /* renamed from: b  reason: collision with root package name */
        final /* synthetic */ Drawable f1869b;

        c(FabTransformationBehavior fabTransformationBehavior, b.c.a.b.p.d dVar, Drawable drawable) {
            this.f1868a = dVar;
            this.f1869b = drawable;
        }

        @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
        public void onAnimationEnd(Animator animator) {
            this.f1868a.setCircularRevealOverlayDrawable(null);
        }

        @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
        public void onAnimationStart(Animator animator) {
            this.f1868a.setCircularRevealOverlayDrawable(this.f1869b);
        }
    }
    ...
    public class d extends AnimatorListenerAdapter {
        ...
        /* renamed from: a  reason: collision with root package name */
        final /* synthetic */ b.c.a.b.p.d f1870a;

        d(FabTransformationBehavior fabTransformationBehavior, b.c.a.b.p.d dVar) {
            this.f1870a = dVar;
        }

        @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
        public void onAnimationEnd(Animator animator) {
            d.e revealInfo = this.f1870a.getRevealInfo();
            revealInfo.f1369c = Float.MAX_VALUE;
            this.f1870a.setRevealInfo(revealInfo);
        }
    }
    ...
    private Pair<i, i> N(float f, float f2, boolean z, e eVar) {
        ...
        int i;
        if (f == 0.0f || f2 == 0.0f) {
            e2 = eVar.f1871a.e("translationXLinear");
            hVar = eVar.f1871a;
            str = "translationYLinear";
        } else if ((!z || f2 >= 0.0f) && (z || i <= 0)) {
            e2 = eVar.f1871a.e("translationXCurveDownwards");
            hVar = eVar.f1871a;
            str = "translationYCurveDownwards";
        } else {
            e2 = eVar.f1871a.e("translationXCurveUpwards");
            hVar = eVar.f1871a;
    ...
    private float S(e eVar, i iVar, float f, float f2) {
        long c2 = iVar.c();
        long d2 = iVar.d();
        i e2 = eVar.f1871a.e("expansion");
        return b.c.a.b.l.a.a(f, f2, iVar.e().getInterpolation(((float) (((e2.c() + e2.d()) + 17) - c2)) / ((float) d2)));
    }
    ...
    private void U(View view, View view2, boolean z, boolean z2, e eVar, List<Animator> list, List<Animator.AnimatorListener> list2) {
        ...
        if (view2 instanceof ViewGroup) {
            if (((view2 instanceof b.c.a.b.p.d) && b.c.a.b.p.c.f1362a == 0) || (K = K(view2)) == null) {
                return;
            }
            if (z) {
                if (!z2) {
                    b.c.a.b.l.d.f1345a.set(K, Float.valueOf(0.0f));
                }
                ofFloat = ObjectAnimator.ofFloat(K, b.c.a.b.l.d.f1345a, 1.0f);
            } else {
                ofFloat = ObjectAnimator.ofFloat(K, b.c.a.b.l.d.f1345a, 0.0f);
            }
            eVar.f1871a.e("contentFade").a(ofFloat);
            list.add(ofFloat);
        }
    }
    ...
    private void V(View view, View view2, boolean z, boolean z2, e eVar, List<Animator> list, List<Animator.AnimatorListener> list2) {
        ...
        if (view2 instanceof b.c.a.b.p.d) {
            b.c.a.b.p.d dVar = (b.c.a.b.p.d) view2;
            int d0 = d0(view);
            int i = 16777215 & d0;
            if (z) {
                if (!z2) {
                ...
                ofInt = ObjectAnimator.ofInt(dVar, d.C0061d.f1366a, i);
            } else {
                ofInt = ObjectAnimator.ofInt(dVar, d.C0061d.f1366a, d0);
            }
            ofInt.setEvaluator(b.c.a.b.l.c.b());
            eVar.f1871a.e("color").a(ofInt);
            list.add(ofInt);
        }
    }

    private void W(View view, View view2, boolean z, e eVar, List<Animator> list) {
        float Q = Q(view, view2, eVar.f1872b);
        float R = R(view, view2, eVar.f1872b);
    ...
    private void X(View view, View view2, boolean z, boolean z2, e eVar, List<Animator> list, List<Animator.AnimatorListener> list2) {
        ...
        eVar.f1871a.e("elevation").a(ofFloat);
        list.add(ofFloat);
    }
    ...
    private void Y(View view, View view2, boolean z, boolean z2, e eVar, float f, float f2, List<Animator> list, List<Animator.AnimatorListener> list2) {
        ...
        if (view2 instanceof b.c.a.b.p.d) {
            b.c.a.b.p.d dVar = (b.c.a.b.p.d) view2;
            float O = O(view, view2, eVar.f1872b);
            float P = P(view, view2, eVar.f1872b);
            ((FloatingActionButton) view).i(this.f1862c);
            float width = this.f1862c.width() / 2.0f;
            i e2 = eVar.f1871a.e("expansion");
            if (z) {
                if (!z2) {
                ...
                if (z2) {
                    width = dVar.getRevealInfo().f1369c;
                }
                animator = b.c.a.b.p.a.a(dVar, O, P, b.c.a.b.v.a.b(O, P, 0.0f, 0.0f, f, f2));
                animator.addListener(new d(this, dVar));
                b0(view2, e2.c(), (int) O, (int) P, width, list);
            } else {
                float f3 = dVar.getRevealInfo().f1369c;
                Animator a2 = b.c.a.b.p.a.a(dVar, O, P, width);
                int i = (int) O;
                int i2 = (int) P;
                b0(view2, e2.c(), i, i2, f3, list);
                a0(view2, e2.c(), e2.d(), eVar.f1871a.f(), i, i2, width, list);
                animator = a2;
            }
            e2.a(animator);
            list.add(animator);
            list2.add(b.c.a.b.p.a.b(dVar));
        }
    }

    private void Z(View view, View view2, boolean z, boolean z2, e eVar, List<Animator> list, List<Animator.AnimatorListener> list2) {
        ObjectAnimator ofInt;
        if ((view2 instanceof b.c.a.b.p.d) && (view instanceof ImageView)) {
            b.c.a.b.p.d dVar = (b.c.a.b.p.d) view2;
            ...
            if (z) {
                ...
                ofInt = ObjectAnimator.ofInt(drawable, b.c.a.b.l.e.f1346b, 0);
            } else {
                ofInt = ObjectAnimator.ofInt(drawable, b.c.a.b.l.e.f1346b, 255);
            }
            ofInt.addUpdateListener(new b(this, view2));
            eVar.f1871a.e("iconFade").a(ofInt);
            list.add(ofInt);
