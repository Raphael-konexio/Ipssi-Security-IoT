...
public class c extends ViewGroup {
    ...
    private void c(Context context, AttributeSet attributeSet) {
        ...
        this.f = obtainStyledAttributes.getDimensionPixelSize(k.FlowLayout_lineSpacing, 0);
        this.g = obtainStyledAttributes.getDimensionPixelSize(k.FlowLayout_itemSpacing, 0);
        ...
        for (int i10 = 0; i10 < getChildCount(); i10++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (layoutParams instanceof ViewGroup.MarginLayoutParams) {
                    ...
                    i6 = a.g.k.g.b(marginLayoutParams);
                    i5 = a.g.k.g.a(marginLayoutParams);
                } else {
                    i5 = 0;
                    i6 = 0;
                }
                ...
                i8 += i6 + i5 + childAt.getMeasuredWidth() + this.g;
    ...
    protected void onMeasure(int i, int i2) {
        ...
        for (int i9 = 0; i9 < getChildCount(); i9++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                int i10 = paddingLeft;
                if (paddingLeft + i3 + childAt.getMeasuredWidth() <= paddingRight || b()) {
                    i5 = i10;
                } else {
                    i5 = getPaddingLeft();
                ...
                paddingLeft = i5 + i3 + i4 + childAt.getMeasuredWidth() + this.g;
