...
public final class m extends z0<Object, com.google.firebase.auth.internal.c> {
    private final com.google.firebase.auth.c y;

    public m(com.google.firebase.auth.c cVar) {
        super(2);
        com.google.android.gms.common.internal.r.i(cVar, "credential cannot be null");
        this.y = cVar;
        com.google.android.gms.common.internal.r.g(cVar.k(), "email cannot be null");
        com.google.android.gms.common.internal.r.g(cVar.n(), "password cannot be null");
    }
    ...
    public final com.google.android.gms.common.api.internal.m<n0, Object> a() {
        ...
        a2.b(new com.google.android.gms.common.api.internal.k(this) { // from class: com.google.firebase.auth.z.a.l

            /* renamed from: a  reason: collision with root package name */
            private final m f1942a;
            ...
            public final void accept(Object obj, Object obj2) {
                this.f1942a.q((n0) obj, (b.c.a.a.f.h) obj2);
            }
        });
        return a2.a();
    }
    ...
    public final /* synthetic */ void q(n0 n0Var, b.c.a.a.f.h hVar) {
        ...
        s0 c2 = n0Var.c();
        if (z) {
            c2.v(this.y.k(), this.y.n(), this.f1962d.x(), this.f1960b);
        } else {
            c2.G(new b.c.a.a.d.c.o0(this.y.k(), this.y.n(), this.f1962d.x()), this.f1960b);
        }
    }
}
