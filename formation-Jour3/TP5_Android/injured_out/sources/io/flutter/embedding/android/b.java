...
public class b {
    ...
    private static final Matrix f2434d = new Matrix();

    /* renamed from: a  reason: collision with root package name */
    private final io.flutter.embedding.engine.renderer.a f2435a;

    /* renamed from: b  reason: collision with root package name */
    private final k f2436b = k.a();
    ...
    private void a(MotionEvent motionEvent, int i, int i2, int i3, Matrix matrix, ByteBuffer byteBuffer) {
        ...
        long d5 = this.f2437c ? this.f2436b.c(motionEvent).d() : 0L;
    ...
    public boolean d(MotionEvent motionEvent) {
        ...
        if (z && z2) {
            ...
            a(motionEvent, motionEvent.getActionIndex(), b2, 0, f2434d, allocateDirect);
            if (allocateDirect.position() % 232 == 0) {
                this.f2435a.g(allocateDirect, allocateDirect.position());
                return true;
            }
    ...
    */
    public boolean f(android.view.MotionEvent r13, android.graphics.Matrix r14) {
        ...
        L6f:
            ...
            int r13 = r13 % 232
            if (r13 != 0) goto L81
            io.flutter.embedding.engine.renderer.a r13 = r12.f2435a
            int r14 = r1.position()
            r13.g(r1, r14)
            return r10
        L81:
