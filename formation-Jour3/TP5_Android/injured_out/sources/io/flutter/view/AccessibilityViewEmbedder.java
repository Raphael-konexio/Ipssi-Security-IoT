...
class AccessibilityViewEmbedder {
    ...
    public static class b {
        ...
        private final Method f2665b;

        /* renamed from: c  reason: collision with root package name */
        private final Method f2666c;

        /* renamed from: d  reason: collision with root package name */
        private final Method f2667d;
        ...
        private b() {
            ...
            try {
                ...
                c.a.b.e(AccessibilityViewEmbedder.TAG, "can't invoke AccessibilityNodeInfo#getSourceNodeId with reflection");
                method = null;
            }
            try {
                method2 = AccessibilityRecord.class.getMethod("getSourceNodeId", new Class[0]);
            } catch (NoSuchMethodException unused2) {
                c.a.b.e(AccessibilityViewEmbedder.TAG, "can't invoke AccessibiiltyRecord#getSourceNodeId with reflection");
                method2 = null;
            }
            if (Build.VERSION.SDK_INT > 26) {
                try {
                    ...
                    c.a.b.e(AccessibilityViewEmbedder.TAG, "can't access childNodeIdsField with reflection");
                    method3 = null;
                    field = null;
                }
                this.f2664a = method;
            ...
            try {
                ...
                c.a.b.e(AccessibilityViewEmbedder.TAG, "can't invoke getParentNodeId with reflection");
                method5 = null;
            }
            try {
                ...
                c.a.b.e(AccessibilityViewEmbedder.TAG, "can't invoke getChildId with reflection");
                method3 = null;
                field2 = null;
            }
            method6 = method5;
        ...
        public Long f(AccessibilityNodeInfo accessibilityNodeInfo, int i) {
            String str;
            if (this.f2667d == null && (this.e == null || this.f == null)) {
                return null;
            }
            ...
            if (method != null) {
                ...
                try {
                    ...
                    c.a.b.f(AccessibilityViewEmbedder.TAG, str, e);
                    return null;
        ...
        private static Long l(AccessibilityNodeInfo accessibilityNodeInfo) {
            if (Build.VERSION.SDK_INT < 26) {
                c.a.b.e(AccessibilityViewEmbedder.TAG, "Unexpected Android version. Unable to find the parent ID.");
                return null;
            }
    ...
    public static class c {
        ...
        public boolean equals(Object obj) {
            ...
            if (obj instanceof c) {
                c cVar = (c) obj;
                return this.f2669b == cVar.f2669b && this.f2668a.equals(cVar.f2668a);
            }
            return false;
        }

        public int hashCode() {
            return ((this.f2668a.hashCode() + 31) * 31) + this.f2669b;
        }
    }
    ...
    public AccessibilityNodeInfo createAccessibilityNodeInfo(int i) {
        ...
        if (cVar == null || !this.embeddedViewToDisplayBounds.containsKey(cVar.f2668a) || cVar.f2668a.getAccessibilityNodeProvider() == null || (createAccessibilityNodeInfo = cVar.f2668a.getAccessibilityNodeProvider().createAccessibilityNodeInfo(cVar.f2669b)) == null) {
            return null;
        }
        return convertToFlutterNode(createAccessibilityNodeInfo, i, cVar.f2668a);
    }
    ...
    public boolean onAccessibilityHoverEvent(int i, MotionEvent motionEvent) {
        ...
        Rect rect = this.embeddedViewToDisplayBounds.get(cVar.f2668a);
        ...
        return cVar.f2668a.dispatchGenericMotionEvent(MotionEvent.obtain(motionEvent.getDownTime(), motionEvent.getEventTime(), motionEvent.getAction(), motionEvent.getPointerCount(), pointerPropertiesArr, pointerCoordsArr, motionEvent.getMetaState(), motionEvent.getButtonState(), motionEvent.getXPrecision(), motionEvent.getYPrecision(), motionEvent.getDeviceId(), motionEvent.getEdgeFlags(), motionEvent.getSource(), motionEvent.getFlags()));
    }

    public boolean performAction(int i, int i2, Bundle bundle) {
        AccessibilityNodeProvider accessibilityNodeProvider;
        c cVar = this.flutterIdToOrigin.get(i);
        if (cVar == null || (accessibilityNodeProvider = cVar.f2668a.getAccessibilityNodeProvider()) == null) {
            return false;
        }
        return accessibilityNodeProvider.performAction(cVar.f2669b, i2, bundle);
    }
