...
public class q implements g<Object> {

    /* renamed from: a  reason: collision with root package name */
    public static final q f1501a = new q();

    /* renamed from: b  reason: collision with root package name */
    private static final boolean f1502b;

    /* renamed from: c  reason: collision with root package name */
    private static final Charset f1503c;
    ...
    static {
        f1502b = ByteOrder.nativeOrder() == ByteOrder.LITTLE_ENDIAN;
        f1503c = Charset.forName("UTF8");
    }
    ...
    protected Object g(byte b2, ByteBuffer byteBuffer) {
        ...
        switch (b2) {
            ...
            case 5:
                return new BigInteger(new String(d(byteBuffer), f1503c), 16);
            case 6:
                c(byteBuffer, 8);
                return Double.valueOf(byteBuffer.getDouble());
            case 7:
                return new String(d(byteBuffer), f1503c);
            case 8:
                return d(byteBuffer);
            case 9:
                int e2 = e(byteBuffer);
    ...
    public void o(ByteArrayOutputStream byteArrayOutputStream, Object obj) {
        ...
        if (obj == null || obj.equals(null)) {
            ...
            if ((obj instanceof Integer) || (obj instanceof Short) || (obj instanceof Byte)) {
                ...
                i(byteArrayOutputStream, ((BigInteger) obj).toString(16).getBytes(f1503c));
            }
        } else if (obj instanceof String) {
            byteArrayOutputStream.write(7);
            i(byteArrayOutputStream, ((String) obj).getBytes(f1503c));
