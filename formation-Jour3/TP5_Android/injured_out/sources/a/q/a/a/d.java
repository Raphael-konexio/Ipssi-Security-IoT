...
public class d {
    ...
    public static class a implements TypeEvaluator<c.b[]> {
        ...
        public c.b[] evaluate(float f, c.b[] bVarArr, c.b[] bVarArr2) {
            if (a.g.d.c.b(bVarArr, bVarArr2)) {
                if (!a.g.d.c.b(this.f434a, bVarArr)) {
                    this.f434a = a.g.d.c.f(bVarArr);
                }
                for (int i = 0; i < bVarArr.length; i++) {
                    this.f434a[i].d(bVarArr[i], bVarArr2[i], f);
                }
                return this.f434a;
            }
    ...
    */
    ...
    private static PropertyValuesHolder e(TypedArray typedArray, int i, int i2, int i3, String str) {
        ...
        c.b[] d2 = a.g.d.c.d(string);
        c.b[] d3 = a.g.d.c.d(string2);
        if (d2 == null && d3 == null) {
            return null;
        }
        if (d2 == null) {
    ...
    private static int g(Resources resources, Resources.Theme theme, AttributeSet attributeSet, XmlPullParser xmlPullParser) {
        TypedArray k = androidx.core.content.d.g.k(resources, theme, attributeSet, a.q.a.a.a.j);
        int i = 0;
        TypedValue l = androidx.core.content.d.g.l(k, xmlPullParser, "value", 0);
        if ((l != null) && h(l.type)) {
            i = 3;
        }
        k.recycle();
    ...
    private static ValueAnimator l(Context context, Resources resources, Resources.Theme theme, AttributeSet attributeSet, ValueAnimator valueAnimator, float f, XmlPullParser xmlPullParser) {
        TypedArray k = androidx.core.content.d.g.k(resources, theme, attributeSet, a.q.a.a.a.g);
        TypedArray k2 = androidx.core.content.d.g.k(resources, theme, attributeSet, a.q.a.a.a.k);
        if (valueAnimator == null) {
            valueAnimator = new ValueAnimator();
        }
        q(valueAnimator, k, k2, f, xmlPullParser);
        int h = androidx.core.content.d.g.h(k, xmlPullParser, "interpolator", 0, 0);
        if (h > 0) {
    ...
    private static Keyframe m(Context context, Resources resources, Resources.Theme theme, AttributeSet attributeSet, int i, XmlPullParser xmlPullParser) {
        TypedArray k = androidx.core.content.d.g.k(resources, theme, attributeSet, a.q.a.a.a.j);
        float f = androidx.core.content.d.g.f(k, xmlPullParser, "fraction", 3, -1.0f);
        TypedValue l = androidx.core.content.d.g.l(k, xmlPullParser, "value", 0);
        boolean z = l != null;
        if (i == 4) {
            i = (z && h(l.type)) ? 3 : 0;
        }
        Keyframe ofInt = z ? i != 0 ? (i == 1 || i == 3) ? Keyframe.ofInt(f, androidx.core.content.d.g.g(k, xmlPullParser, "value", 0, 0)) : null : Keyframe.ofFloat(f, androidx.core.content.d.g.f(k, xmlPullParser, "value", 0, 0.0f)) : i == 0 ? Keyframe.ofFloat(f) : Keyframe.ofInt(f);
        int h = androidx.core.content.d.g.h(k, xmlPullParser, "interpolator", 1, 0);
        if (h > 0) {
    ...
    private static PropertyValuesHolder[] p(Context context, Resources resources, Resources.Theme theme, XmlPullParser xmlPullParser, AttributeSet attributeSet) {
        ...
        while (true) {
            ...
            if (eventType == 2 && xmlPullParser.getName().equals("propertyValuesHolder")) {
                TypedArray k = androidx.core.content.d.g.k(resources, theme, attributeSet, a.q.a.a.a.i);
                String i2 = androidx.core.content.d.g.i(k, xmlPullParser, "propertyName", 3);
                int g = androidx.core.content.d.g.g(k, xmlPullParser, "valueType", 2, 4);
    ...
    private static void q(ValueAnimator valueAnimator, TypedArray typedArray, TypedArray typedArray2, float f, XmlPullParser xmlPullParser) {
        long g = androidx.core.content.d.g.g(typedArray, xmlPullParser, "duration", 1, 300);
        long g2 = androidx.core.content.d.g.g(typedArray, xmlPullParser, "startOffset", 2, 0);
        int g3 = androidx.core.content.d.g.g(typedArray, xmlPullParser, "valueType", 7, 4);
        if (androidx.core.content.d.g.j(xmlPullParser, "valueFrom") && androidx.core.content.d.g.j(xmlPullParser, "valueTo")) {
            if (g3 == 4) {
                g3 = f(typedArray, 5, 6);
            }
        ...
        valueAnimator.setRepeatCount(androidx.core.content.d.g.g(typedArray, xmlPullParser, "repeatCount", 3, 0));
        valueAnimator.setRepeatMode(androidx.core.content.d.g.g(typedArray, xmlPullParser, "repeatMode", 4, 1));
        if (typedArray2 != null) {
    ...
    private static void r(ValueAnimator valueAnimator, TypedArray typedArray, int i, float f, XmlPullParser xmlPullParser) {
        ...
        String i2 = androidx.core.content.d.g.i(typedArray, xmlPullParser, "pathData", 1);
        if (i2 == null) {
            objectAnimator.setPropertyName(androidx.core.content.d.g.i(typedArray, xmlPullParser, "propertyName", 0));
            return;
        }
        String i3 = androidx.core.content.d.g.i(typedArray, xmlPullParser, "propertyXName", 2);
        String i4 = androidx.core.content.d.g.i(typedArray, xmlPullParser, "propertyYName", 3);
        if (i != 2) {
        }
        if (i3 != null || i4 != null) {
            s(a.g.d.c.e(i2), objectAnimator, f * 0.5f, i3, i4);
            return;
        }
