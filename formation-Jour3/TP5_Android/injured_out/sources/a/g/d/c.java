...
public class c {
    ...
    public static class b {
        ...
        b(b bVar) {
            ...
            float[] fArr = bVar.f139b;
            this.f139b = c.c(fArr, 0, fArr.length);
        }
        ...
        public static void e(b[] bVarArr, Path path) {
            ...
            for (int i = 0; i < bVarArr.length; i++) {
                a(path, fArr, c2, bVarArr[i].f138a, bVarArr[i].f139b);
                c2 = bVarArr[i].f138a;
            }
        }
        ...
        public void d(b bVar, b bVar2, float f) {
            ...
            while (true) {
                ...
                this.f139b[i] = (fArr[i] * (1.0f - f)) + (bVar2.f139b[i] * f);
                i++;
            }
        }
    }
    ...
    public static boolean b(b[] bVarArr, b[] bVarArr2) {
        ...
        for (int i = 0; i < bVarArr.length; i++) {
            if (bVarArr[i].f138a != bVarArr2[i].f138a || bVarArr[i].f139b.length != bVarArr2[i].f139b.length) {
                return false;
            }
        }
        return true;
    ...
    */
    private static void g(java.lang.String r8, int r9, a.g.d.c.a r10) {
        /*
            r0 = 0
            r10.f137b = r0
            r1 = r9
        ...
        L3b:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: a.g.d.c.g(java.lang.String, int, a.g.d.c$a):void");
    }
    ...
    public static void j(b[] bVarArr, b[] bVarArr2) {
        for (int i = 0; i < bVarArr2.length; i++) {
            bVarArr[i].f138a = bVarArr2[i].f138a;
            for (int i2 = 0; i2 < bVarArr2[i].f139b.length; i2++) {
                bVarArr[i].f139b[i2] = bVarArr2[i].f139b[i2];
            }
        }
    }
}
