...
public final class t {
    ...
    private static Method f282a;

    static {
        if (Build.VERSION.SDK_INT == 25) {
            try {
                f282a = ViewConfiguration.class.getDeclaredMethod("getScaledScrollFactor", new Class[0]);
    ...
    private static float a(ViewConfiguration viewConfiguration, Context context) {
        Method method;
        if (Build.VERSION.SDK_INT >= 25 && (method = f282a) != null) {
            try {
