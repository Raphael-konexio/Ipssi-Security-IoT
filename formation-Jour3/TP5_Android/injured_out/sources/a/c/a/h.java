...
class h extends Drawable {
    ...
    private void e(Canvas canvas) {
        float f = this.f;
        float f2 = (-f) - this.i;
        float f3 = f + this.f57a + (this.j / 2.0f);
        float f4 = f3 * 2.0f;
        ...
        canvas.drawPath(this.g, this.f59c);
        if (z) {
            canvas.drawRect(0.0f, f2, this.e.width() - f4, -this.f, this.f60d);
        }
        ...
        canvas.drawPath(this.g, this.f59c);
        if (z) {
            canvas.drawRect(0.0f, f2, this.e.width() - f4, (-this.f) + this.i, this.f60d);
        }
        ...
        canvas.drawPath(this.g, this.f59c);
        if (z2) {
            canvas.drawRect(0.0f, f2, this.e.height() - f4, -this.f, this.f60d);
        }
    ...
    private void n(ColorStateList colorStateList) {
        ...
        this.f58b.setColor(colorStateList.getColorForState(getState(), this.k.getDefaultColor()));
    }
    ...
    private void s(float f, float f2) {
        if (f < 0.0f) {
            ...
            this.j = t;
            this.h = t2;
            this.i = (int) ((t * 1.5f) + this.f57a + 0.5f);
            this.l = true;
            invalidateSelf();
        }
    }
    ...
    public void draw(Canvas canvas) {
        ...
        e(canvas);
        canvas.translate(0.0f, (-this.j) / 2.0f);
        r.a(canvas, this.e, this.f, this.f58b);
    }
    ...
    public float j() {
        float f = this.h;
        return (Math.max(f, this.f + this.f57a + ((f * 1.5f) / 2.0f)) * 2.0f) + (((this.h * 1.5f) + this.f57a) * 2.0f);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public float k() {
        float f = this.h;
        return (Math.max(f, this.f + this.f57a + (f / 2.0f)) * 2.0f) + ((this.h + this.f57a) * 2.0f);
    }
    ...
    protected boolean onStateChange(int[] iArr) {
        ...
        if (this.f58b.getColor() == colorForState) {
            return false;
        }
        this.f58b.setColor(colorForState);
        this.l = true;
        invalidateSelf();
        return true;
    }
    ...
    public void setAlpha(int i) {
        this.f58b.setAlpha(i);
        this.f59c.setAlpha(i);
        this.f60d.setAlpha(i);
    }

    @Override // android.graphics.drawable.Drawable
    public void setColorFilter(ColorFilter colorFilter) {
        this.f58b.setColorFilter(colorFilter);
    }
}
