...
public class d extends RecyclerView.n implements RecyclerView.s {
    ...
    final StateListDrawable f1085c;

    /* renamed from: d  reason: collision with root package name */
    final Drawable f1086d;
    private final int e;
    private final int f;
    ...
    private class C0053d implements ValueAnimator.AnimatorUpdateListener {
        ...
        public void onAnimationUpdate(ValueAnimator valueAnimator) {
            ...
            d.this.f1085c.setAlpha(floatValue);
            d.this.f1086d.setAlpha(floatValue);
            d.this.v();
        }
    }
    ...
    public d(RecyclerView recyclerView, StateListDrawable stateListDrawable, Drawable drawable, StateListDrawable stateListDrawable2, Drawable drawable2, int i, int i2, int i3) {
        ...
        this.f1083a = i2;
        this.f1084b = i3;
        this.f1085c.setAlpha(255);
        this.f1086d.setAlpha(255);
        this.z.addListener(new c());
        this.z.addUpdateListener(new C0053d());
        j(recyclerView);
    }
    ...
    private void n(Canvas canvas) {
        ...
        int i5 = this.k;
        int i6 = i4 - (i5 / 2);
        this.f1085c.setBounds(0, 0, i2, i5);
        this.f1086d.setBounds(0, 0, this.f, this.r);
        if (s()) {
            this.f1086d.draw(canvas);
            canvas.translate(this.e, i6);
            canvas.scale(-1.0f, 1.0f);
            this.f1085c.draw(canvas);
            canvas.scale(1.0f, 1.0f);
            i3 = this.e;
        } else {
    ...
    void B(int i, int i2) {
        ...
        int i3 = this.r;
        this.t = computeVerticalScrollRange - i3 > 0 && i3 >= this.f1083a;
        int computeHorizontalScrollRange = this.s.computeHorizontalScrollRange();
        int i4 = this.q;
        boolean z = computeHorizontalScrollRange - i4 > 0 && i4 >= this.f1083a;
        this.u = z;
        if (!this.t && !z) {
            if (this.v != 0) {
                y(0);
