...
public class i {
    ...
    private void c(List<a.b> list, int i, a.b bVar, int i2, a.b bVar2) {
        int i3 = bVar.f1049d < bVar2.f1047b ? -1 : 0;
        if (bVar.f1047b < bVar2.f1047b) {
            i3++;
        }
        int i4 = bVar2.f1047b;
        int i5 = bVar.f1047b;
        if (i4 <= i5) {
            bVar.f1047b = i5 + bVar2.f1049d;
        }
        int i6 = bVar2.f1047b;
        int i7 = bVar.f1049d;
        if (i6 <= i7) {
            bVar.f1049d = i7 + bVar2.f1049d;
        }
        bVar2.f1047b += i3;
        list.set(i, bVar2);
        list.set(i2, bVar);
    ...
    /* JADX WARN: Code restructure failed: missing block: B:46:0x009e, code lost:
        if (r0 > r14.f1047b) goto L39;
     */
    /* JADX WARN: Code restructure failed: missing block: B:59:0x00c8, code lost:
        if (r0 >= r14.f1047b) goto L39;
     */
    /* JADX WARN: Code restructure failed: missing block: B:60:0x00ca, code lost:
        r12.f1049d = r0 - r14.f1049d;
     */
    /*
    ...
    */
    void f(java.util.List<androidx.recyclerview.widget.a.b> r9, int r10, androidx.recyclerview.widget.a.b r11, int r12, androidx.recyclerview.widget.a.b r13) {
        ...
        Ld:
            ...
            int r5 = r5 - r4
            r13.f1049d = r5
            androidx.recyclerview.widget.i$a r0 = r8.f1104a
            int r1 = r11.f1047b
            java.lang.Object r5 = r13.f1048c
        ...
        L2b:
            ...
            int r5 = r5 + r6
            int r5 = r5 - r1
            androidx.recyclerview.widget.i$a r3 = r8.f1104a
            int r1 = r1 + r4
            java.lang.Object r4 = r13.f1048c
        ...
        L4c:
            r9.remove(r10)
            androidx.recyclerview.widget.i$a r11 = r8.f1104a
            r11.a(r13)
        L54:
            if (r0 == 0) goto L59
            r9.add(r10, r0)
