...
class b extends a {
    ...
    private final SparseIntArray f1139d;
    ...
    protected a b() {
        ...
        int i2 = i;
        return new b(parcel, dataPosition, i2, this.h + "  ", this.f1136a, this.f1137b, this.f1138c);
    }
    ...
    public void w(int i) {
        a();
        this.i = i;
        this.f1139d.put(i, this.e.dataPosition());
        E(0);
        E(i);
    }
