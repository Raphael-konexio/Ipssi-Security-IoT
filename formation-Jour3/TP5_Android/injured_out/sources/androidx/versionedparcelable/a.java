...
public abstract class a {
    ...
    protected final a.d.a<String, Method> f1136a;

    /* renamed from: b  reason: collision with root package name */
    protected final a.d.a<String, Method> f1137b;

    /* renamed from: c  reason: collision with root package name */
    protected final a.d.a<String, Class> f1138c;
    ...
    private Class c(Class<? extends c> cls) {
        Class cls2 = this.f1138c.get(cls.getName());
        if (cls2 == null) {
            Class<?> cls3 = Class.forName(String.format("%s.%sParcelizer", cls.getPackage().getName(), cls.getSimpleName()), false, cls.getClassLoader());
            this.f1138c.put(cls.getName(), cls3);
            return cls3;
        }
        return cls2;
    }
    ...
    private Method d(String str) {
        Method method = this.f1136a.get(str);
        if (method == null) {
            System.currentTimeMillis();
            Method declaredMethod = Class.forName(str, true, a.class.getClassLoader()).getDeclaredMethod("read", a.class);
            this.f1136a.put(str, declaredMethod);
    ...
    private Method e(Class cls) {
        Method method = this.f1137b.get(cls.getName());
        if (method == null) {
            Class c2 = c(cls);
            System.currentTimeMillis();
            Method declaredMethod = c2.getDeclaredMethod("write", cls, a.class);
            this.f1137b.put(cls.getName(), declaredMethod);
            return declaredMethod;
        }
        return method;
    }
