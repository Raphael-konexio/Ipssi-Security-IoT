...
public class CoordinatorLayout extends ViewGroup implements l, m {
    ...
    private static final a.g.j.f<Rect> D;
    static final String z;
    private final List<View> f;
    private final androidx.coordinatorlayout.widget.a<View> g;
    ...
    public static class f extends ViewGroup.MarginLayoutParams {
        ...
        f(Context context, AttributeSet attributeSet) {
            ...
            this.f690c = obtainStyledAttributes.getInteger(a.f.c.CoordinatorLayout_Layout_android_layout_gravity, 0);
            this.f = obtainStyledAttributes.getResourceId(a.f.c.CoordinatorLayout_Layout_layout_anchor, -1);
            this.f691d = obtainStyledAttributes.getInteger(a.f.c.CoordinatorLayout_Layout_layout_anchorGravity, 0);
            ...
            this.f689b = hasValue;
            if (hasValue) {
                this.f688a = CoordinatorLayout.K(context, attributeSet, obtainStyledAttributes.getString(a.f.c.CoordinatorLayout_Layout_layout_behavior));
            }
        ...
        private boolean s(View view, int i) {
            int b2 = a.g.k.d.b(((f) view.getLayoutParams()).g, i);
            return b2 != 0 && (a.g.k.d.b(this.h, i) & b2) == b2;
        }
        ...
        boolean b(CoordinatorLayout coordinatorLayout, View view, View view2) {
            c cVar;
            return view2 == this.l || s(view2, s.w(coordinatorLayout)) || ((cVar = this.f688a) != null && cVar.e(coordinatorLayout, view, view2));
        }
    ...
    public CoordinatorLayout(Context context, AttributeSet attributeSet, int i2) {
        ...
        this.g = new androidx.coordinatorlayout.widget.a<>();
        ...
        this.v = obtainStyledAttributes.getDrawable(a.f.c.CoordinatorLayout_statusBarBackground);
        obtainStyledAttributes.recycle();
        X();
    ...
    private void C(View view, int i2) {
        ...
        if (this.t != null && s.t(this) && !s.t(view)) {
            a2.left += this.t.i();
            a2.top += this.t.k();
            a2.right -= this.t.j();
            a2.bottom -= this.t.h();
        ...
        Rect a3 = a();
        a.g.k.d.a(S(fVar.f690c), view.getMeasuredWidth(), view.getMeasuredHeight(), a2, a3, i2);
    ...
    private void E(View view, int i2, int i3) {
        f fVar = (f) view.getLayoutParams();
        int b2 = a.g.k.d.b(T(fVar.f690c), i3);
        int i4 = b2 & 7;
        int i5 = b2 & 112;
        int width = getWidth();
    ...
    static c K(Context context, AttributeSet attributeSet, String str) {
        ...
        } else if (str.indexOf(46) < 0 && !TextUtils.isEmpty(z)) {
            str = z + '.' + str;
        }
        try {
            Map<String, Constructor<c>> map = B.get();
            if (map == null) {
                map = new HashMap<>();
                B.set(map);
            }
    ...
    private a0 f(a0 a0Var) {
        ...
        for (int i2 = 0; i2 < childCount; i2++) {
            View childAt = getChildAt(i2);
            if (s.t(childAt) && (f2 = ((f) childAt.getLayoutParams()).f()) != null) {
    ...
    private void v(View view, int i2, Rect rect, Rect rect2, f fVar, int i3, int i4) {
        int b2 = a.g.k.d.b(R(fVar.f690c), i2);
        int b3 = a.g.k.d.b(S(fVar.f691d), i2);
        int i5 = b2 & 7;
        int i6 = b2 & 112;
        int i7 = b3 & 7;
        int i8 = b3 & 112;
    ...
    void G(View view, int i2) {
        ...
        if (fVar.k != null) {
            ...
            e(fVar, a4, measuredWidth, measuredHeight);
        ...
        for (int i3 = 0; i3 < size; i3++) {
            ...
            if (i2 != 0 || view.getVisibility() != 8) {
                for (int i4 = 0; i4 < i3; i4++) {
                    if (fVar.l == this.f.get(i4)) {
                        G(view, w);
                    }
                }
                q(view, true, a3);
                if (fVar.g != 0 && !a3.isEmpty()) {
                    int b2 = a.g.k.d.b(fVar.g, w);
                    int i5 = b2 & 112;
                    if (i5 == 48) {
    ...
    final a0 W(a0 a0Var) {
        if (!a.g.j.d.a(this.t, a0Var)) {
            this.t = a0Var;
            boolean z2 = true;
            boolean z3 = a0Var != null && a0Var.k() > 0;
            this.u = z3;
    ...
    protected boolean drawChild(Canvas canvas, View view, long j) {
        ...
        if (cVar != null) {
            ...
            if (d2 > 0.0f) {
                ...
                this.j.setColor(fVar.f688a.c(this, view));
                this.j.setAlpha(d(Math.round(d2 * 255.0f), 0, 255));
    ...
    public void onDraw(Canvas canvas) {
        ...
        a0 a0Var = this.t;
        int k = a0Var != null ? a0Var.k() : 0;
        if (k > 0) {
            this.v.setBounds(0, 0, getWidth(), k);
            this.v.draw(canvas);
        }
    }
    ...
    protected void onLayout(boolean z2, int i2, int i3, int i4, int i5) {
        ...
        for (int i6 = 0; i6 < size; i6++) {
            ...
            if (view.getVisibility() != 8 && ((f2 = ((f) view.getLayoutParams()).f()) == null || !f2.l(this, view, w))) {
                I(view, w);
            }
        }
    }
    ...
    */
    ...
    protected void onRestoreInstanceState(Parcelable parcelable) {
        ...
        SparseArray<Parcelable> sparseArray = hVar.h;
        int childCount = getChildCount();
        for (int i2 = 0; i2 < childCount; i2++) {
            View childAt = getChildAt(i2);
