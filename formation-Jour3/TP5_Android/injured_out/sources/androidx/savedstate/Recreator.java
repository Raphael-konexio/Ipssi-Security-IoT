...
final class Recreator implements h {
    ...
    static final class a implements SavedStateRegistry.b {
        ...
        /* renamed from: a  reason: collision with root package name */
        final Set<String> f1128a = new HashSet();
        ...
        public Bundle a() {
            ...
            bundle.putStringArrayList("classes_to_restore", new ArrayList<>(this.f1128a));
            return bundle;
        }
    ...
    private void h(String str) {
        ...
        try {
            try {
                ...
                try {
                    ((SavedStateRegistry.a) declaredConstructor.newInstance(new Object[0])).a(this.f1127a);
                } catch (Exception e) {
    ...
    public void d(j jVar, e.a aVar) {
        ...
        jVar.a().c(this);
        Bundle a2 = this.f1127a.j().a("androidx.savedstate.Restarter");
        if (a2 == null) {
            return;
        }
