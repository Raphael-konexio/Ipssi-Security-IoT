...
public final class i {
    ...
    private static class a implements ActionMode.Callback {
        ...
        private final ActionMode.Callback f778a;

        /* renamed from: b  reason: collision with root package name */
        private final TextView f779b;

        /* renamed from: c  reason: collision with root package name */
        private Class<?> f780c;

        /* renamed from: d  reason: collision with root package name */
        private Method f781d;
        private boolean e;
        ...
        private void f(Menu menu) {
            Context context = this.f779b.getContext();
            ...
            if (!this.f) {
                ...
                try {
                    ...
                    this.f780c = cls;
                    this.f781d = cls.getDeclaredMethod("removeItemAt", Integer.TYPE);
                    this.e = true;
            ...
            try {
                Method declaredMethod = (this.e && this.f780c.isInstance(menu)) ? this.f781d : menu.getClass().getDeclaredMethod("removeItemAt", Integer.TYPE);
                ...
                for (int i = 0; i < c2.size(); i++) {
                    ...
                    menu.add(0, 0, i + 100, resolveInfo.loadLabel(packageManager)).setIntent(b(resolveInfo, this.f779b)).setShowAsAction(1);
                }
        ...
        public boolean onActionItemClicked(ActionMode actionMode, MenuItem menuItem) {
            return this.f778a.onActionItemClicked(actionMode, menuItem);
        }

        @Override // android.view.ActionMode.Callback
        public boolean onCreateActionMode(ActionMode actionMode, Menu menu) {
            return this.f778a.onCreateActionMode(actionMode, menu);
        }

        @Override // android.view.ActionMode.Callback
        public void onDestroyActionMode(ActionMode actionMode) {
            this.f778a.onDestroyActionMode(actionMode);
        }

        @Override // android.view.ActionMode.Callback
        public boolean onPrepareActionMode(ActionMode actionMode, Menu menu) {
            f(menu);
            return this.f778a.onPrepareActionMode(actionMode, menu);
        }
    }
    ...
    public static c.a f(TextView textView) {
        ...
        c.a.C0009a c0009a = new c.a.C0009a(new TextPaint(textView.getPaint()));
    ...
    public static void m(TextView textView, a.g.i.c cVar) {
