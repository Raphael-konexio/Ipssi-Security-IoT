...
public class m {
    ...
    private static Map<Class<?>, Integer> f897a = new HashMap();

    /* renamed from: b  reason: collision with root package name */
    private static Map<Class<?>, List<Constructor<? extends d>>> f898b = new HashMap();
    ...
    private static int d(Class<?> cls) {
        Integer num = f897a.get(cls);
        if (num != null) {
            return num.intValue();
        }
        int g = g(cls);
        f897a.put(cls, Integer.valueOf(g));
        return g;
    }
    ...
    public static h f(Object obj) {
        ...
        if (d(cls) == 2) {
            List<Constructor<? extends d>> list = f898b.get(cls);
            if (list.size() == 1) {
    ...
    private static int g(Class<?> cls) {
        ...
        if (b2 != null) {
            f898b.put(cls, Collections.singletonList(b2));
            return 2;
        } else if (a.f880c.d(cls)) {
            return 1;
        } else {
            ...
            if (e(superclass)) {
                ...
                arrayList = new ArrayList(f898b.get(superclass));
            }
            for (Class<?> cls2 : cls.getInterfaces()) {
                if (e(cls2)) {
                    ...
                    arrayList.addAll(f898b.get(cls2));
                }
            }
            if (arrayList != null) {
                f898b.put(cls, arrayList);
                return 2;
            }
            return 1;
        }
