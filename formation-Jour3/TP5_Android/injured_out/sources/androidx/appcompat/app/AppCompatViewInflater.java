...
public class AppCompatViewInflater {
    ...
    public static class a implements View.OnClickListener {
        ...
        private void a(Context context, String str) {
            ...
            if (this.f.getId() == -1) {
                ...
                str2 = " with id '" + this.f.getContext().getResources().getResourceEntryName(id) + "'";
            }
            throw new IllegalStateException("Could not find method " + this.g + "(View) in a parent or ancestor Context for android:onClick attribute defined on view " + this.f.getClass() + str2);
        }
    ...
    private void checkOnClickListener(View view, AttributeSet attributeSet) {
        ...
        if (context instanceof ContextWrapper) {
            if (Build.VERSION.SDK_INT < 15 || s.H(view)) {
    ...
    private static Context themifyContext(Context context, AttributeSet attributeSet, boolean z, boolean z2) {
        ...
        obtainStyledAttributes.recycle();
        return resourceId != 0 ? ((context instanceof a.a.n.d) && ((a.a.n.d) context).b() == resourceId) ? context : new a.a.n.d(context, resourceId) : context;
    }
    ...
    protected androidx.appcompat.widget.s createRadioButton(Context context, AttributeSet attributeSet) {
