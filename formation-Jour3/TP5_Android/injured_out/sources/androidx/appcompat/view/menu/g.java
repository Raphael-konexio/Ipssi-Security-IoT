...
public class g implements a.g.e.a.a {
    ...
    public g(Context context) {
        this.f547a = context;
        this.f548b = context.getResources();
        b0(true);
    }
    ...
    private void b0(boolean z) {
        boolean z2 = true;
        this.f550d = (z && this.f548b.getConfiguration().keyboard != 1 && t.e(ViewConfiguration.get(this.f547a), this.f547a)) ? false : false;
    }
    ...
    private boolean j(r rVar, m mVar) {
        ...
        boolean e = mVar != null ? mVar.e(rVar) : false;
        Iterator<WeakReference<m>> it = this.w.iterator();
        while (it.hasNext()) {
            WeakReference<m> next = it.next();
            m mVar2 = next.get();
    ...
    */
    ...
    public MenuItem add(int i) {
        return a(0, 0, 0, this.f548b.getString(i));
    }

    @Override // android.view.Menu
    public MenuItem add(int i, int i2, int i3, int i4) {
        return a(i, i2, i3, this.f548b.getString(i4));
    }
    ...
    public SubMenu addSubMenu(int i) {
        return addSubMenu(0, 0, 0, this.f548b.getString(i));
    }

    @Override // android.view.Menu
    public SubMenu addSubMenu(int i, int i2, int i3, int i4) {
        return addSubMenu(i, i2, i3, this.f548b.getString(i4));
    }

    @Override // android.view.Menu
    public SubMenu addSubMenu(int i, int i2, int i3, CharSequence charSequence) {
        i iVar = (i) a(i, i2, i3, charSequence);
        r rVar = new r(this.f547a, this, iVar);
        iVar.x(rVar);
        return rVar;
    }
