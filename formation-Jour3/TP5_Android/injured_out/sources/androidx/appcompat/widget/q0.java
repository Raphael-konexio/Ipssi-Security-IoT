...
class q0 extends a.h.a.c implements View.OnClickListener {
    ...
    private CharSequence l(CharSequence charSequence) {
        if (this.x == null) {
            ...
            this.i.getTheme().resolveAttribute(a.a.a.textColorSearchUrl, typedValue, true);
            this.x = this.i.getResources().getColorStateList(typedValue.resourceId);
        }
    ...
    private Drawable n(ComponentName componentName) {
        ...
        if (!this.t.containsKey(flattenToShortString)) {
            ...
            this.t.put(flattenToShortString, m != null ? m.getConstantState() : null);
            return m;
        }
        Drawable.ConstantState constantState = this.t.get(flattenToShortString);
        if (constantState == null) {
            return null;
        }
        return constantState.newDrawable(this.s.getResources());
    }
    ...
    private Drawable p(Cursor cursor) {
        Drawable n = n(this.r.getSearchActivity());
        return n != null ? n : this.i.getPackageManager().getDefaultActivityIcon();
    }
    ...
    private Drawable s(String str) {
        ...
        try {
            ...
            Drawable d2 = androidx.core.content.a.d(this.s, parseInt);
            A(str2, d2);
            return d2;
        } catch (Resources.NotFoundException unused) {
    ...
    public CharSequence c(Cursor cursor) {
        ...
        if (!this.r.shouldRewriteQueryFromData() || (o2 = o(cursor, "suggest_intent_data")) == null) {
            if (!this.r.shouldRewriteQueryFromText() || (o = o(cursor, "suggest_text_1")) == null) {
                return null;
            }
            return o;
        }
    ...
    public Cursor d(CharSequence charSequence) {
        ...
        if (this.q.getVisibility() == 0 && this.q.getWindowVisibility() == 0) {
            try {
                Cursor v = v(this.r, charSequence2, 50);
                if (v != null) {
                    v.getCount();
                    return v;
                }
    ...
    public void e(View view, Context context, Cursor cursor) {
        ...
        if (aVar.f635a != null) {
            z(aVar.f635a, w(cursor, this.y));
        }
        if (aVar.f636b != null) {
            String w = w(cursor, this.A);
            CharSequence l = w != null ? l(w) : w(cursor, this.z);
    ...
    public View getDropDownView(int i, View view, ViewGroup viewGroup) {
        try {
            ...
            View g = g(this.i, this.h, viewGroup);
            if (g != null) {
                ((a) g.getTag()).f635a.setText(e.toString());
            }
            return g;
        }
    }
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        try {
            ...
            Log.w("SuggestionsAdapter", "Search suggestions cursor threw exception.", e);
            View h = h(this.i, this.h, viewGroup);
            if (h != null) {
                ((a) h.getTag()).f635a.setText(e.toString());
            }
            return h;
        }
    }
    ...
    public View h(Context context, Cursor cursor, ViewGroup viewGroup) {
        ...
        h.setTag(new a(h));
        ((ImageView) h.findViewById(a.a.f.edit_query)).setImageResource(this.u);
        return h;
    }
    ...
    Cursor v(SearchableInfo searchableInfo, String str, int i) {
        ...
        return this.i.getContentResolver().query(fragment.build(), null, suggestSelection, strArr2, null);
    }
