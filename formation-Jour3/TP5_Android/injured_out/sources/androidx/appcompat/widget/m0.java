...
public final class m0 {
    ...
    private WeakHashMap<Context, a.d.h<ColorStateList>> f620a;

    /* renamed from: b  reason: collision with root package name */
    private a.d.a<String, d> f621b;

    /* renamed from: c  reason: collision with root package name */
    private a.d.h<String> f622c;

    /* renamed from: d  reason: collision with root package name */
    private final WeakHashMap<Context, a.d.d<WeakReference<Drawable.ConstantState>>> f623d = new WeakHashMap<>(0);
    ...
    private void a(String str, d dVar) {
        if (this.f621b == null) {
            this.f621b = new a.d.a<>();
        }
        this.f621b.put(str, dVar);
    }
    ...
    private synchronized boolean b(Context context, long j2, Drawable drawable) {
        ...
        if (constantState != null) {
            a.d.d<WeakReference<Drawable.ConstantState>> dVar = this.f623d.get(context);
            if (dVar == null) {
                dVar = new a.d.d<>();
                this.f623d.put(context, dVar);
            }
    ...
    private void c(Context context, int i2, ColorStateList colorStateList) {
        ...
        a.d.h<ColorStateList> hVar = this.f620a.get(context);
        if (hVar == null) {
            hVar = new a.d.h<>();
            this.f620a.put(context, hVar);
        }
    ...
    private void d(Context context) {
        ...
        this.f = true;
        Drawable j2 = j(context, a.a.m.a.abc_vector_test);
        if (j2 == null || !q(j2)) {
            this.f = false;
    ...
    private ColorStateList n(Context context, int i2) {
        ...
        WeakHashMap<Context, a.d.h<ColorStateList>> weakHashMap = this.f620a;
    ...
    private Drawable r(Context context, int i2) {
        int next;
        a.d.a<String, d> aVar = this.f621b;
        if (aVar == null || aVar.isEmpty()) {
            return null;
        }
        a.d.h<String> hVar = this.f622c;
        if (hVar != null) {
            String e2 = hVar.e(i2);
            if ("appcompat_skip_skip".equals(e2) || (e2 != null && this.f621b.get(e2) == null)) {
                return null;
            }
        } else {
            this.f622c = new a.d.h<>();
        }
        if (this.e == null) {
            this.e = new TypedValue();
        }
        ...
        if (charSequence != null && charSequence.toString().endsWith(".xml")) {
            try {
                ...
                this.f622c.a(i2, name);
                d dVar = this.f621b.get(name);
                if (dVar != null) {
        ...
        if (i3 == null) {
            this.f622c.a(i2, "appcompat_skip_skip");
        }
        return i3;
    }
    ...
    public static void w(Drawable drawable, u0 u0Var, int[] iArr) {
        ...
        if (u0Var.f653d || u0Var.f652c) {
            drawable.setColorFilter(g(u0Var.f653d ? u0Var.f650a : null, u0Var.f652c ? u0Var.f651b : h, iArr));
        } else {
    ...
    public synchronized Drawable k(Context context, int i2, boolean z) {
        ...
        if (r == null) {
            r = androidx.core.content.a.d(context, i2);
        }
        if (r != null) {
            r = v(context, i2, z, r);
        }
