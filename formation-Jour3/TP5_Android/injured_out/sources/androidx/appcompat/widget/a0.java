...
public class a0 {
    ...
    private float f588c = -1.0f;

    /* renamed from: d  reason: collision with root package name */
    private float f589d = -1.0f;
    ...
    private boolean C(int i, RectF rectF) {
        ...
        q(i);
        StaticLayout e = e(text, (Layout.Alignment) r(this.i, "getLayoutAlignment", Layout.Alignment.ALIGN_NORMAL), Math.round(rectF.right), maxLines);
    ...
    private boolean z() {
        if (D() && this.f586a == 1) {
            if (!this.g || this.f.length == 0) {
                int floor = ((int) Math.floor((this.e - this.f589d) / this.f588c)) + 1;
                int[] iArr = new int[floor];
                for (int i = 0; i < floor; i++) {
                    iArr[i] = Math.round(this.f589d + (i * this.f588c));
                }
                this.f = c(iArr);
            }
            this.f587b = true;
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public int k() {
        return Math.round(this.f589d);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public int l() {
        return Math.round(this.f588c);
    }
    ...
    public void t(AttributeSet attributeSet, int i) {
        ...
        if (obtainStyledAttributes.hasValue(a.a.j.AppCompatTextView_autoSizeTextType)) {
            this.f586a = obtainStyledAttributes.getInt(a.a.j.AppCompatTextView_autoSizeTextType, 0);
        }
